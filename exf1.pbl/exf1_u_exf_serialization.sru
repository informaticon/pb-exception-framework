forward
global type exf1_u_exf_serialization from nonvisualobject
end type
end forward

global type exf1_u_exf_serialization from nonvisualobject
end type
global exf1_u_exf_serialization exf1_u_exf_serialization
...
//Bugfix PB2017R3 1880: empty string
//TODO Can be removed with PB2022R2
if as_base64 = '' then
	return blob('')
end if
...
on exf1_u_exf_serialization.create
call super::create
TriggerEvent( this, "constructor" )
end on

on exf1_u_exf_serialization.destroy
