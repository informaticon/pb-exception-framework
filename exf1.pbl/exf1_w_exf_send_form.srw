forward
global type exf1_w_exf_send_form from window
end type
type st_description_help from statictext within exf1_w_exf_send_form
end type
type cb_cancel from commandbutton within exf1_w_exf_send_form
end type
type cb_ok from commandbutton within exf1_w_exf_send_form
end type
type st_sender from statictext within exf1_w_exf_send_form
end type
type st_description from statictext within exf1_w_exf_send_form
end type
type mle_description from multilineedit within exf1_w_exf_send_form
end type
type sle_sender from singlelineedit within exf1_w_exf_send_form
end type
end forward
...
global exf1_w_exf_send_form exf1_w_exf_send_form
...
on exf1_w_exf_send_form.create
...
on exf1_w_exf_send_form.destroy
