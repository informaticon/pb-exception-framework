forward
global type exf1_u_exf_error_data from nonvisualobject
end type
end forward

global type exf1_u_exf_error_data from nonvisualobject
end type
global exf1_u_exf_error_data exf1_u_exf_error_data
...
try
	lpo_value = aa_value
	return of_push(as_key, aa_value)
...
on exf1_u_exf_error_data.create
call super::create
TriggerEvent( this, "constructor" )
end on

on exf1_u_exf_error_data.destroy
