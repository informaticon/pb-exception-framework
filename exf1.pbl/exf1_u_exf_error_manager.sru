forward
global type exf1_u_exf_error_manager from nonvisualobject
end type
type st_encrypt_result from structure within exf1_u_exf_error_manager
end type
type iu_as from u_exf_error_creator within exf1_u_exf_error_manager
end type
end forward
...
global exf1_u_exf_error_manager exf1_u_exf_error_manager
...
) system library 'exf1.dll' alias for 'Stack_Trace'
end prototypes
type variables
...
on exf1_u_exf_error_manager.create
call super::create
this.iu_as=create iu_as
TriggerEvent( this, "constructor" )
end on

on exf1_u_exf_error_manager.destroy
...
type iu_as from u_exf_error_creator within exf1_u_exf_error_manager descriptor "pb_nvo" = "true" 
end type
