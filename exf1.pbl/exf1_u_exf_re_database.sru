forward
global type exf1_u_exf_re_database from u_exf_re
end type
end forward

global type exf1_u_exf_re_database from u_exf_re
end type
global exf1_u_exf_re_database exf1_u_exf_re_database
...
pu_error.of_push('sql.sqlsyntax', blob(as_sqlsyntax)) //Zusätzlich als blob abspeichern, für den Fall, dass Platz in Key-Val Store nicht reicht
...
on exf1_u_exf_re_database.create
call super::create
end on

on exf1_u_exf_re_database.destroy
call super::destroy
end on
